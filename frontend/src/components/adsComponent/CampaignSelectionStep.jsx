...
const CampaignSelectionStep = ({
  ...
  const sampleContentIdeas = [
    ...
    {
      id: 2,
      title: "✨ Inside Modern Cloud Architecture",
      description: "An exclusive look at how enterprises build cloud-native systems for performance, security, and global reach",
    ...
    {
      id: 3,
      title: "Cloud Tip Tuesday: Optimize Costs 💡 #CloudComputing #FinOps #MultiCloud #HybridCloud #DevOps #Kubernetes #Serverless #DataSecurity #CloudOptimization #CostManagement",
      description: "Quick weekly tip to optimize cloud infrastructure costs while maintaining speed and reliability",
      type: "Social Post",
      contentType: "hashtag",
    ...
    {
      id: 4,
      title: "💡 10 Cloud Security Practices Every Team Should Know",
      description: "Essential cloud security strategies to protect data, ensure compliance, and mitigate modern cyber risks.",
      type: "Text Post",
      contentType: "text",
    ...
    {
      id: 5,
      title: "🌍 Inside a Global Cloud Data Center",
      description: "Take a virtual tour of cutting-edge cloud facilities powering mission-critical applications worldwide",
      type: "Video",
      contentType: "video",
    ...
    },
    {
      ...
      description: "How a legacy enterprise successfully migrated to the cloud, achieving scalability and cost savings",
      type: "Case Study",
      contentType: "image",
    ...
    {
      id: 7,
      title: "Friday Tech Talk ☁️ What's trending in cloud this week? Drop your thoughts below! 👇 #CloudTrends #Serverless #Kubernetes #MultiCloud #DataSecurity #HybridCloud #Innovation #Scalability #DevOps #CloudCommunity",
      description: "Engagement post to spark community discussion on the latest cloud technology trends and practices",
      type: "Social Post",
      contentType: "hashtag",
    ...
    },
    {
      ...
      description: "Insights into why enterprises adopt multi-cloud setups, how it improves resilience, and key success factors.",
      type: "Educational",
      contentType: "text",
