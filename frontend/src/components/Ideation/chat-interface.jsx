      ...
      <div className="w-96 border-r border-gray-200 bg-white">
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center gap-2 mb-2">
            <button onClick={onBack} className="p-1 rounded hover:bg-gray-100 transition">
        ...
        <div ref={scrollAreaRef} className="h-[calc(100vh-120px)] overflow-y-auto p-6">
          {loading && messages.length === 0 ? (
            ...
            <div className="prose prose-sm max-w-none">
              <div className="whitespace-pre-wrap text-sm text-gray-800">{messages[0]?.content}</div>
            </div>
          )}
        </div>
      </div>
